...
[Vitest](https://vitest.dev/) est un framework de test unitaire très rapide développé par Vite. Parce que QwikCity utilise [Vite](https://vitejs.dev/) par défaut, Vitest est notre framework de test unitaire de facto.
