...
Progressivement, il s'agit de charger le code au fur et à mesure des besoins de l'application, sans avoir à charger l'ensemble de la base de code en amont.
