...
### Bouton avec un gestionnaire de clics
...
### Créer une horloge qui s'incrémente toutes les secondes
...
### Effectuer une requête fetch chaque fois que l'état change
...
### Déclarer un contexte et le consommer
...
## Créer une saisie avec un affichage retardé
...
### Changer la couleur de fond de manière aléatoire à chaque clic sur un bouton
...
### Créer un composant qui fait le rendu de la liste des présidents
