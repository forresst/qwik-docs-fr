...
- Vous pouvez également lire [Pensez Qwik](../think-qwik/index.mdx)
...
REMARQUE : En cliquant sur le bouton, l'état est mis à jour et l'interface utilisateur est actualisée.
