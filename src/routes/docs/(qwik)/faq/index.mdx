...
Vous pouvez déployer facilement une appli Qwik dans n'importe quel [environnement sans serveur grâce à nos adaptateurs](/deployments/index.mdx), nous supportons également un [adaptateur vanilla-node](/deployments/node/index.mdx) pour les serveurs basés sur Nodejs, tel que Express.
