...
Vous pouvez déployer facilement une appli Qwik dans n'importe quel [environnement sans serveur grâce à nos adaptateurs](/deployments/index.mdx), nous supportons également un [adaptateur vanilla-node](/deployments/node/index.mdx) pour les serveurs basés sur Node.js, tel que Express.
...
Oui ! Qwik peut exécuter des composants React en natif, [consultez les docs](/integrations/react/index.mdx).
