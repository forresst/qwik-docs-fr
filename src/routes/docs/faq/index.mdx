...
## Est-ce que *@QwikDev* est une IA intelligente ?
...
- **Similaire à HTML** : JSX est visuellement et conceptuellement similaire à HTML, une arborescence. D'autres systèmes de template comme *html templates* (lit-html) ne sont pas des arborescence mais des tableaux de tokens, ce qui rend plus difficile la construction par dessus et la transformation.
...
Cela dépend. Pour le SPA, la plupart des coûts sont réglés en amont, en téléchargeant tout au début de la session. Ainsi, lorsqu'un utilisateur interagit avec l'appli, le coût est minime.

## Le MPA est plus rapide que le SPA

Cela dépend, le MPA est extrêmement rapide à charger, car il n'a pas besoin de télécharger beaucoup de JS, mais lorsque l'utilisateur navigue, cela signifie généralement un rechargement complet de la page.

Un rechargement complet de la page est généralement super rapide, car les navigateurs sont extrêmement rapides pour télécharger et analyser le HTML, mais l'approche SPA ne convient pas à tout le monde, car il est parfois idéal de conserver l'état entre les navigations, et SPA le fait très bien.
...
Cela dépend, les rechargements de pages complètes sont extrêmement rapides, parce que les navigateurs sont extrêmement rapides pour télécharger et analyser le HTML, mais l'approche SPA n'est pas pour tout le monde, car il est parfois nécessaire de conserver un état entre les pages, et le SPA le fait très bien.
