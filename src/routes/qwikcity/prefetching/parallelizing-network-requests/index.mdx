...
Dans cet exemple, lorsque le module A est appelé pour la première fois, le navigateur ne sait pas qu'il doit également demander les modules B et C. Il ne sait même pas qu'il doit commencer à demander le module B avant que le module A ne soit terminé. Il ne sait même pas qu'il doit commencer à demander le module `B`, seulement APRÈS que le module `A` ait fini de se télécharger. Il s'agit d'un problème courant dans la mesure où le navigateur ne sait pas à l'avance ce qu'il doit commencer à demander, jusqu'à ce que le chargement de chaque module soit terminé.
