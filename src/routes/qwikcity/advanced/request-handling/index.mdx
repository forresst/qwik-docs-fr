...
Qwik City implémente un système de middleware basé sur la hiérarchie du répertoire `src/routes`. Le système middleware est utilisé pour gérer les requêtes et les réponses HTTP, et est disponible pour les pages, les mises en page, et les [endpoints] (/qwikcity/endpoints/index.mdx).
