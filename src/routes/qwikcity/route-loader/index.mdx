...
Vous ne devriez pas utiliser un routeLoader pour créer une API REST, pour cela il vaut mieux utiliser un [Endpoint](/qwikcity/endpoints/index.mdx), qui vous permet d'avoir un contrôle précis sur les entêtes et le corps de la réponse.
