...
[Lisez le guide complet ici](https://github.com/BuilderIO/qwik/tree/main/starters/adaptors/cloudflare-pages/README.md)

## Déploiement du développement en local

Pour déployer l'application pour le développement en local :
...
Après avoir installé l'intégration en utilisant `npm run qwik add`. Le projet est prêt à être déployé sur Cloudflare Pages. Cependant, vous devrez créer un dépôt git et y pousser le code.
