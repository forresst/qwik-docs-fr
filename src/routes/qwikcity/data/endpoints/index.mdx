...
Pour consommer les données récupérées sur un endpoint, vous pouvez utiliser le hook `useResource$` fourni ou le composant `<Resource />` comme décrit [ici](../../../../routes/docs/components/resource/index.mdx).
